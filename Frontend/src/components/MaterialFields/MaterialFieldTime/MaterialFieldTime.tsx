...
function MaterialFiledTime(
    ...
    return (
        <div className="input-field col s4">
            <Field type="time" as={displayAs} className={classes} name={name} />
...
export default connect<MaterialFiledProps>(MaterialFiledTime);